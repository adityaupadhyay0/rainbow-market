...
import { ToolRegistry, ReadFileTool, WriteFileTool, WebAccessTool, CodeExecutionTool } from '@itfs/l3-tooling';
...
run().catch((e) => {
  ...
  console.log('\nTask execution failed (Expected if Ollama is offline):', e.message);
});
